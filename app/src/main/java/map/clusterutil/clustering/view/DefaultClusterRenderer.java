...
package map.clusterutil.clustering.view;
...
import map.clusterutil.MarkerManager;
import map.clusterutil.clustering.Cluster;
import map.clusterutil.clustering.ClusterItem;
import map.clusterutil.clustering.ClusterManager;
import map.clusterutil.projection.Point;
import map.clusterutil.projection.SphericalMercatorProjection;
import map.clusterutil.ui.IconGenerator;

import static map.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        map.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private map.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        map.clusterutil.ui.SquareTextView squareTextView =
                new map.clusterutil.ui.SquareTextView(context);
