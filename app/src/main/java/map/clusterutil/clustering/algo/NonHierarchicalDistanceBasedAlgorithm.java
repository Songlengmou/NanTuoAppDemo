...
package map.clusterutil.clustering.algo;
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                map.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new map.clusterutil.clustering.algo
