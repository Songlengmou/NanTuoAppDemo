 ...
 * 演示MapView的基本用法
 */
public class BaseMapOfflineActivity extends AppCompatActivity {
    @SuppressWarnings("unused")
    private static final String LTAG = BaseMapOfflineActivity.class.getSimpleName();
    ...
    private void initView(Context context) {
        ...
        openBtn.setText(R.string.open_map);
        ...
        closeBtn.setText(R.string.close_map);
