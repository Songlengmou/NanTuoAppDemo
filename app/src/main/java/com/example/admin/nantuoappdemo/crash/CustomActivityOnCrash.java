...
package com.example.admin.nantuoappdemo.crash;
...
public final class CustomActivityOnCrash {
    ...
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.td.tdlibrary";
    //Extras passed to the error activity
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = CAOC_HANDLER_PACKAGE_NAME + ".EXTRA_RESTART_ACTIVITY_CLASS";
    private static final String EXTRA_SHOW_ERROR_DETAILS = CAOC_HANDLER_PACKAGE_NAME + ".EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = CAOC_HANDLER_PACKAGE_NAME + ".EXTRA_STACK_TRACE";
    private static final String EXTRA_IMAGE_DRAWABLE_ID = CAOC_HANDLER_PACKAGE_NAME + ".EXTRA_IMAGE_DRAWABLE_ID";
    private static final String EXTRA_EVENT_LISTENER = CAOC_HANDLER_PACKAGE_NAME + ".EXTRA_EVENT_LISTENER";

    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = CAOC_HANDLER_PACKAGE_NAME + ".ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = CAOC_HANDLER_PACKAGE_NAME + ".RESTART";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.td.tdlibrary.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.td.tdlibrary.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.td.tdlibrary.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.td.tdlibrary.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
