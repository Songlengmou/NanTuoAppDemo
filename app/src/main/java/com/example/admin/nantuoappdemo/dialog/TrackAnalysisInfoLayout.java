package com.example.admin.nantuoappdemo.dialog;
...
import com.example.admin.nantuoappdemo.activity.footprint.TrackQueryActivity;
...
public class TrackAnalysisInfoLayout extends LinearLayout {
    ...
    public TrackAnalysisInfoLayout(final TrackQueryActivity parent, final BaiduMap baiduMap) {
        ...
        titleText = mView.findViewById(R.id.tv_dialog_title);
        key1 = mView.findViewById(R.id.info_key_1);
        key2 = mView.findViewById(R.id.info_key_2);
        key3 = mView.findViewById(R.id.info_key_3);
        key4 = mView.findViewById(R.id.info_key_4);
        value1 = mView.findViewById(R.id.info_value_1);
        value2 = mView.findViewById(R.id.info_value_2);
        value3 = mView.findViewById(R.id.info_value_3);
        value4 = mView.findViewById(R.id.info_value_4);
