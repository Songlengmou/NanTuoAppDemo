...
import com.example.admin.nantuoappdemo.dialog.DateDialog;
 ...
 * 鹰眼足迹查询设置
 */
public class TrackQueryOptionsActivity extends RxActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    Button startTimeBtn = null;
    @Bind(R.id.end_time)
    Button endTimeBtn = null;
    @Bind(R.id.processed)
    CheckBox processedCBx = null;
    @Bind(R.id.denoise)
    CheckBox denoiseCBx = null;
    @Bind(R.id.vacuate)
    CheckBox vacuateCBx = null;
    @Bind(R.id.mapmatch)
    CheckBox mapmatchCBx = null;
    @Bind(R.id.radius_threshold)
    TextView radiusText = null;
    ...
    public void onFinish(View v) {
        ...
        RadioGroup transportModeGroup = findViewById(R.id.transport_mode);
        RadioButton transportModeBtn = findViewById(transportModeGroup.getCheckedRadioButtonId());
        ...
        RadioGroup supplementModeOptionGroup = findViewById(R.id.supplement_mode);
        RadioButton supplementModeOptionRadio =
                findViewById(supplementModeOptionGroup.getCheckedRadioButtonId());
        ...
        RadioGroup sortTypeGroup = findViewById(R.id.sort_type);
        RadioButton sortTypeRadio = findViewById(sortTypeGroup.getCheckedRadioButtonId());
        ...
        RadioGroup coordTypeOutputGroup = findViewById(R.id.coord_type_output);
        RadioButton coordTypeOutputOptionBtn = findViewById(coordTypeOutputGroup.getCheckedRadioButtonId());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                startActivity(new Intent(TrackQueryOptionsActivity.this, TrackQueryActivity.class));
                return true;
            default:
