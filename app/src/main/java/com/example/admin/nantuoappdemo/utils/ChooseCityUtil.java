...
import com.example.admin.nantuoappdemo.bean.CityBean;
import com.example.admin.nantuoappdemo.bean.CityData;
...
public class ChooseCityUtil implements View.OnClickListener, NumberPicker.OnValueChangeListener {
    ...
    public void createDialog(Context context, String[] oldCityArray, ChooseCityInterface cityInterface) {
        ...
        tvSure = window.findViewById(R.id.tvSure);
        tvCancel.setOnClickListener(this);
        tvSure.setOnClickListener(this);
        npProvince = window.findViewById(R.id.npProvince);
        npCity = window.findViewById(R.id.npCity);
        npCounty = window.findViewById(R.id.npCounty);
