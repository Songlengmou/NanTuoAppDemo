...
public class TrackAnalysisDialog extends PopupWindow {
    ...
    public TrackAnalysisDialog(final TrackQueryActivity parent) {
        ...
        speedingCBx = mView.findViewById(R.id.chk_speeding);
        harshBreakingCBx = mView.findViewById(R.id.chk_harsh_breaking);
        harshAccelCBx = mView.findViewById(R.id.chk_harsh_accel);
        stayPointCBx = mView.findViewById(R.id.chk_stay_point);
        titleText = mView.findViewById(R.id.tv_dialog_title);
        cancelBtn = mView.findViewById(R.id.btn_all_cancel);
