...
import com.example.admin.nantuoappdemo.dialog.TrackAnalysisDialog;
import com.example.admin.nantuoappdemo.dialog.TrackAnalysisInfoLayout;
 ...
 * 轨迹查询
 */
public class TrackQueryActivity extends RxActivity implements CompoundButton.OnCheckedChangeListener, View.OnClickListener, BaiduMap.OnMarkerClickListener {
...
//                break;
            case android.R.id.home:
                startActivity(new Intent(TrackQueryActivity.this, TraceMainActivity.class));
                return true;
        }
